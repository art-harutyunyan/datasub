describe("Test suite for Request a Quote functionality", () => {
  ...
  it("Test Case 2: Verify correct request a quote", () => {
    ...
    // verifying if the form is cleared after requesting a quote
    cy.get("#q_name").should("have.value", "");
    cy.get("#q_email").should("have.value", "");
    cy.get("#q_service").should("have.value", "");
    cy.get("#q_message").should("have.value", "");
  });
});
